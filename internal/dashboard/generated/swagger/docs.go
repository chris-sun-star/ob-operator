    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ac.CreateRoleParam"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ac.PatchRoleParam"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/api/v1/cluster/nodes/update": {
            "post": {
                ...
                "operationId": "BatchUpdateK8sNodes",
                "parameters": [
                    {
                        "description": "batch update nodes request body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/param.BatchUpdateNodesParam"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/cluster/nodes/{name}/labels": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "update node labels request body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/param.NodeLabels"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/cluster/nodes/{name}/taints": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "update node taints request body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/param.NodeTaints"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/inspection.PolicyMeta"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/inspection/policies/{namespace}/{name}/{scenario}/trigger": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/inspection/reports/{namespace}/{name}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/k8s/clusters": {
            "get": {
                ...
                "operationId": "ListRemoteK8sClusters",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/k8s.K8sClusterInfo"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "operationId": "CreateRemoteK8sCluster",
                "parameters": [
                    {
                        "description": "create k8s cluster request body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/k8s.CreateK8sClusterParam"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/k8s/clusters/{clusterName}/nodes/{nodeName}/labels": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/k8s/clusters/{clusterName}/nodes/{nodeName}/taints": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "PutRemoteK8sNodeTaints",
                "parameters": [
                    {
                        "type": "string",
                        "description": "k8s cluster name",
        ...
        "/api/v1/k8s/clusters/{name}": {
            "get": {
                ...
                "operationId": "GetRemoteK8sCluster",
                "parameters": [
                    {
                        "type": "string",
                        "description": "k8s cluster name",
            ...
            "delete": {
                ...
                "operationId": "DeleteRemoteK8sCluster",
                "parameters": [
                    {
                        "type": "string",
                        "description": "k8s cluster name",
            ...
            "patch": {
                ...
                "operationId": "PatchRemoteK8sCluster",
                "parameters": [
                    {
                        "type": "string",
                        "description": "k8s cluster name",
                    ...
                    {
                        "description": "update k8s cluster request body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/k8s.UpdateK8sClusterParam"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/k8s/clusters/{name}/events": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "ListRemoteK8sEvents",
                "parameters": [
                    {
                        "type": "string",
                        "description": "k8s cluster name",
        ...
        "/api/v1/k8s/clusters/{name}/nodes": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "ListRemoteK8sNodes",
                "parameters": [
                    {
                        "type": "string",
                        "description": "k8s cluster name",
        ...
        "/api/v1/k8s/clusters/{name}/nodes/update": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "BatchUpdateRemoteK8sNode",
                "parameters": [
                    {
                        "type": "string",
                        "description": "k8s cluster name",
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.MonitorEndpoint"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/v1/obclusters/namespace/{namespace}/name/{name}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "patch obcluster request body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/param.PatchOBClusterParam"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/obclusters/namespace/{namespace}/name/{name}/log": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "DownloadOBClusterLog",
                "parameters": [
                    {
                        "type": "string",
                        "description": "obcluster namespace",
        ...
        "/api/v1/obclusters/namespace/{namespace}/name/{name}/observers": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "delete observers request body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/param.DeleteOBServersParam"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/obclusters/namespace/{namespace}/name/{name}/parameters": {
            "get": {
                ...
                "operationId": "ListOBClusterParameters",
                "parameters": [
                    {
                        "type": "string",
                        "description": "namespace of obcluster resource",
                        "name": "namespace",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "name of obcluster resource",
                        "name": "name",
                        "in": "path",
                        "required": true
                    }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.AggregatedParameter"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/v1/obclusters/namespace/{namespace}/name/{name}/restart": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "restart observers request body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/param.RestartOBServersParam"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/obtenants/{namespace}/{name}/sql-analyzer": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/sql/querySqlHistoryInfo": {
            "post": {
                ...
                "operationId": "QuerySqlHistoryInfo",
                "parameters": [
                    {
                        "description": "param for query history sql info",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sql.SqlHistoryParam"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/sql.SqlHistoryInfo"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/sql/requestStatistics": {
            "post": {
                ...
                "operationId": "ListRequestStatistics",
                "parameters": [
                    {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/sql.SqlStatsList"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "common.AffinitySpec": {
            ...
            "properties": {
                ...
                "operator": {
                    "description": "Enum: In, NotIn, Exists, DoesNotExist",
                    "type": "string"
                },
                "preferred": {
                    "type": "boolean"
                ...
                "type": {
                    "description": "Enum: NODE, POD, POD_ANTI",
                    "allOf": [
                        {
        ...
        "common.TolerationSpec": {
            ...
            "properties": {
                "effect": {
                    "description": "Enum: PreferNoSchedule, NoSchedule, NoExecute",
                    "type": "string"
                },
                "key": {
                    "type": "string"
        ...
        "inspection.Policy": {
            ...
            "properties": {
                ...
                "obCluster": {
                    "$ref": "#/definitions/response.OBClusterMetaBasic"
                },
                "scheduleConfig": {
                    "type": "array",
                    "items": {
        ...
        "param.BackupDestType": {
            ...
            "x-enum-varnames": [
                ...
                "BackupDestCOS",
                "BackupDestS3",
                "BackupDestS3Compatible"
            ]
        },
        "param.BatchUpdateNodesParam": {
            "type": "object",
            "required": [
                "nodes"
            ],
            "properties": {
                "labelOperations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/param.labelOperation"
                    }
                },
                "nodes": {
                    "type": "array",
                ...
                "taintOperations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/param.taintOperation"
                    }
                }
            }
        },
        ...
        "param.CreateBackupPolicy": {
            ...
            "properties": {
                ...
                "destType": {
                    "description": "Enum: NFS, OSS, COS, S3, S3_COMPATIBLE",
                    "allOf": [
                        {
                            "$ref": "#/definitions/param.BackupDestType"
                        }
                    ],
                    "example": "NFS"
                },
        ...
        "param.PatchOBClusterParam": {
            ...
            "properties": {
                ...
                "deletedParameters": {
                    "description": "Delete some parameters",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "modifiedParameters": {
                    "description": "Add or modify some parameters",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/common.KVPair"
                    }
        ...
        "param.ResourcePoolSpec": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "Enum: Full, Readonly, Columnstore",
                    "type": "string"
                },
                "zone": {
                    "type": "string"
        ...
        "param.RestoreSourceSpec": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "Enum: OSS, NFS, COS, S3, S3_COMPATIBLE",
                    "allOf": [
                        {
                            "$ref": "#/definitions/param.BackupDestType"
                        }
        ...
        "param.ZoneTopology": {
            ...
            "properties": {
                ...
                "tolerations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/common.TolerationSpec"
                    }
                },
                "zone": {
                    "type": "string"
        ...
        "param.labelOperation": {
            ...
            "properties": {
                ...
                "operation": {
                    "$ref": "#/definitions/param.NodeOperation"
                },
                "value": {
                    "type": "string"
                }
        ...
        "response.AggregatedParameter": {
            ...
            "properties": {
                ...
                "values": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.AggregratedParameterValue"
                    }
                }
            }
        },
        "response.AggregratedParameterValue": {
            "type": "object",
            "properties": {
                "metas": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.ParameterMeta"
                    }
                },
                "metasStr": {
                    "type": "string"
        ...
        "response.OBCluster": {
            ...
            "properties": {
                ...
                "parameters": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.ParameterSpec"
                    }
                },
                "pvcIndependent": {
                    "type": "boolean"
        ...
        "response.OBTenantDetail": {
            ...
            "properties": {
                ...
                "deletionProtection": {
                    "description": "Whether the tenant is protected from deletion",
                    "type": "boolean"
                },
                "locality": {
                ...
                "sqlAnalyzerEnabled": {
                    "description": "Whether the sql analyzer is enabled",
                    "type": "boolean"
                },
                "standbyROCredential": {
                    "type": "string"
